...
export const H4 = ({ children, className, ...props }: Props) => {
  return <h4 className={`text-xl md:text-2xl lg:text-3xl xl:text-4xl ${className}`}>{children}</h4>;
};
...
export const H6 = ({ children, className, ...props }: Props) => {
  return <h6 className={`text-base md:text-lg lg:text-xl xl:text-2xl ${className}`}>{children}</h6>;
};
